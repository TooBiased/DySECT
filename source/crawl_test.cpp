...
template <class Config> struct test_type
{
                   ...
                   std::string inf_name)
    {
        ...
        otm::out() << otm::width(9) << "cap" << otm::width(9) << "time"
                   << otm::width(10) << "doubles" << otm::width(9) << "individ"
                   << otm::width(9) << "err"
#ifdef MALLOC_COUNT
                   << otm::width(7) << "mem" << otm::width(7) << "mx_mem"
#endif
                   << std::endl;
        ...
        for (size_t i = 0; i < it; ++i)
        {
            ...
            otm::out() << otm::width(9) << cap << otm::width(9) << ttest
                       << otm::width(10) << contained << otm::width(9)
                       << individual << otm::width(9) << errors
#ifdef MALLOC_COUNT
                       << otm::width(7)
