...
class cuckoo_deamortized
    : public cuckoo_traits<cuckoo_deamortized<K, D, HF, Conf> >::base_type
{
  private:
  ...
  private:
    ...
    {
        for (size_type i = 0; i < nh; ++i) { mem[i] = getBucket(h, i); }
    }
