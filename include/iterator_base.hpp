...
template <class Increment, bool is_const = false> class iterator_base
{
  private:
    ...
    using cval_intern  = typename std::conditional<is_const, const value_intern,
                                                  value_intern>::type;
  ...
  public:
    ...
    template <class T, bool b>
    friend bool
    operator==(const iterator_base<T, b>& l, const iterator_base<T, b>& r);
    template <class T, bool b>
    friend bool
    operator!=(const iterator_base<T, b>& l, const iterator_base<T, b>& r);
