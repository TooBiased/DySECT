...
class prob_linear_doubling
    : public prob_traits<prob_linear_doubling<K, D, HF, Conf> >::base_type
{
  private:
...
class prob_linear : public prob_traits<prob_linear<K, D, HF, Conf> >::base_type
{
  ...
  public:
    ...
    prob_linear(size_type cap = 0, double size_constraint = 1.1,
                size_type /*steps*/ = 0)
...
template <class K, class D, class HF = utils_tm::hash_tm::default_hash,
          class Conf = triv_config>
class prob_linear_inplace
    : public prob_traits<prob_linear_inplace<K, D, HF, Conf> >::base_type
{
  private:
  ...
  public:
    prob_linear_inplace(size_type cap = 0, double size_constraint = 1.1,
                        size_type /*steps*/ = 0)
